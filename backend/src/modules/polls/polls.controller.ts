...
import type { PollsService } from "@/modules/polls/polls.service";

export const pollsController = (pollsService: PollsService) => {
  return {
...
export type PollsController = ReturnType<typeof pollsController>;